#pragma once
#ifndef __EASYKEY_CONFIG_H__
#define __EASYKEY_CONFIG_H__
...
// 使用动态内存申请，如果不使用FreeRTOS的API，请在Easykey.h中的宏替换自己的API
#define CONFIG_DYNAMIC_ALLOCATION 0

// FIFO的队列长度
#define CONFIG_FIFO_BUFFER_SIZE 10

// 使用FreeRTOS的队列实现按键事件传输
#define CONFIG_FREE_RTOS_QUEUE 1
